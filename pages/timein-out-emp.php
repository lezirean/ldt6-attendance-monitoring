            ...
            <ul class="list-unstyled components">
                ...
                <li>
                    ...
                    <ul class="collapse list-unstyled" id="attendanceSubmenu">
                        <li>
                            <a href="timeIn-out-emp.php">Attendance Form</a>
                        </li>
                    </ul>
                ...
                <div class="time">
                   ...
                   <?php 
                      ...
                      function checkSched($schedResult) {
                        ...
                        //TODO: Check if may schedule ung currently logged in na employee
                   ...
                   <form method="POST" name="form" action="insertAttendance-emp.php">
                    ...
                    <!--Issue: hindi nakakapag-time out-->                
