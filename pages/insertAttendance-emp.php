  ...
  if(isset($_POST['time'])) {
    ...
    if($_POST['attendanceFlag'] == true) {
      ...
      if ($connection->query($sql) === TRUE) {
        ...
        header("Location: timeIn-out-emp.php?error=Record inserted successfully."); //culprit kung bakit nagre-redirect sa insertAttendance.php        
        exit();
      } else {
      ...
      header("Location: timeIn-out-emp.php?error=You have already checked out.");        
      exit();
      ...
      if ($connection->query($sql) === TRUE) {
        ...
        header("Location: timeIn-out-emp.php?error=You have checked out."); //culprit kung bakit nagre-redirect sa insertAttendance.php        
        exit();
      } else {
        echo "Error: " . $sql . "<br>" . $conn->error;
      }
